...
test('getRow should return row class', function(t){
  t.equal(flexboxgrid().getRow(), '.row{display:flex;flex-wrap:wrap;}\n')
  t.end()
})

test('getRowGutters should return row gutter class', function(t){
  t.equal(flexboxgrid().getRowGutters(), '.gutters > .row{margin-left: -1rem;}\n')
  t.end()
})


test('getColumnGutters should return column gutter class', function(t){
  t.equal(flexboxgrid().getColumnGutters(), '.gutters > .row > .column{padding-left: 1rem;}\n')
  t.end()
})
